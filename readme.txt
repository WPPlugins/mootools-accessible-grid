...
MooTools Accessible Grid is a WAI-ARIA Enabled Grid Plugin for Wordpress

== Description ==

MooTools Accessible Grid is a grid in your blog and uses the MooTools WAI-ARIA enabled grid.
